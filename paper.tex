...
With the above argument, a task constrained-deadline $\tau_k$ can be feasibly scheduled by a fixed-priority scheduling if
\begin{equation}
\label{eq:TDA-suspension}
\exists 0 < t \leq D_k, \qquad C_k + B_k + \sum_{i=1}^{k-1}
\end{equation}
