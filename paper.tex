...
schedulability test for self-suspending real-time task systems by Jane
W. S. Liu in the textbook \cite{Liu:2000:RS:518501}, since the proof was not provided in the textbook.
...
\item A higher-priority task $\tau_i$ can only block the execution of task $\tau_k$ by at most $min(C_i, S_i)$ time units.
\end{itemize}
