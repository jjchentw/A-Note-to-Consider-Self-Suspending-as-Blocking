...
This report presents a proof to support the correctness of the feasibility test for self-suspending real-time task systems by Jane W. S. Liu in the textbook \cite{1}. Since there was no proof in the book, this report provides the reasoning of the correctness.  
