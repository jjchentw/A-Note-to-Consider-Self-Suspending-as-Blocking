...
Corollary~\ref{corollary:general-framework} can be applied.
 ...
 \begin{example}
  Consider the three tasks $\tau_1 = (4, 5, 10, 10)$, $\tau_2 =(6, 1, 19, 19)$ and $\tau_3 = (4, 0, 35, 35)$.

According to Eq.~(\ref{eq:TDA-jitter}), $\tau_1$ and $\tau_2$ are schedulable under
fixed-priority. 
...
\end{itemize}
Among the above four cases, the tests in Cases 2 and 4 are the tightest. By
