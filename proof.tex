...
\label{lemma:remove-lower-priority}
  For a schedule, based on fixed-priority scheduling, removing a lower-priority job arrived at time $t$ does not change the execution of the higher-priority jobs after time $t$.
\end{lemma}
