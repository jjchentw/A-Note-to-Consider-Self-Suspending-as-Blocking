...
Suppose that $F=|{\bf T}_1|$ and these $F$ tasks are indexed from $1, 2, 3, \ldots, F$. In the $i$-th iteration, we will define $t_i$ as the \emph{release time} of the first job of task $\tau_{F+1-i}$ in the revised schedule. 
